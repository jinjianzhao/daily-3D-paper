...
**arXiv**: https://arxiv.org/abs/2604.21003  
**AlphaXiv**: https://www.alphaxiv.org/zh/overview/2604.21003  
**HF Paper**: https://hf-mirror.com/papers/2604.21003  
**HF Votes**: 1
...
当前为特定任务部署AI代理需人工精心设计其工作框架，过程繁琐且依赖专家。
提出双层自动化框架：内层进化特定任务的执行框架；外层进化框架设计蓝本，实现新任务零人工适配。
...
**arXiv**: https://arxiv.org/abs/2604.25032  
**AlphaXiv**: https://www.alphaxiv.org/zh/overview/2604.25032  
**HF Paper**: https://hf-mirror.com/papers/2604.25032  

## 简要摘要

*推荐系统;公平性评估;离线评估指标*

评估推荐系统公平性日益重要，但现有公平性评估指标存在诸多局限且缺乏对其稳健性的分析。
本文通过理论/实证分析揭示现有指标缺陷，提出改进的评估方法与指标，并给出选用指南。
