...
FOCUS_SECTIONS = [
    ...
    },
    {
        ...
        "keywords": [
            "世界模型", "world model", 
            "世界模型是用于理解现实世界动态 (包括物理属性和空间属性) 的神经网络。它们可以使用文本、图像、视频和运动等输入数据来生成模拟实际物理环境的视频。",
            "一般论文名或者摘要中会包含 world model 等关键词"
            # "机器人", "具身智能", "机器人操作", "机械臂", "抓取", "操控",
            # "运动规划", "控制", "导航", "强化学习机器人", "VLA", "机器人强化学习"
        ],
        "exclude": ["医学图像分析", "生物医学", "纯大语言模型", "蛋白质设计", "蛋白质结构预测", "纯机器人", "纯具身智能", "机器人交互"],
    },
    {
